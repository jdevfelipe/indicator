<template>
  <div>
      ...
      <template v-slot:body="props">
        <q-tr :props="props">
          ...
          <!-- <q-td key="inactive" :props="props">
            <q-btn size="sm" color="accent" round dense icon="clear" @click="deleteUser(props.row.id)"/>
          </q-td> -->
        </q-tr>
      </template>
    </q-table>
    ...
    <edit-dialog @updateList="updateList" @close="show = false" :user="userProp" :show="show" v-if="show"/>
  </div>
</template>

<script>
import EditDialog from '../users/edit-dialog-user'
export default {
